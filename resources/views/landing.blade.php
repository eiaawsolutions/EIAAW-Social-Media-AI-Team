        ...
        <div class="rvl elegant-figure receipt-card">
          <div class="receipt-card-inner">
            ...
            <div style="margin-top: 22px; padding-top: 22px; border-top: 1px dashed var(--line); font-size: 13px; color: var(--ink-2); line-height: 1.6;">
              ...
              <div style="margin-top: 6px;"><strong>Brand voice score:</strong> 0.91 / 0.70 threshold &middot; <strong>Compliance:</strong> 8 / 8 passed</div>
...
<section id="how" class="section-pad">
  <div class="wrap">
    ...
    <div class="grid-12">
      <div style="grid-column: 1 / span 5;">
        ...
        <p style="margin-top: 24px; color: var(--ink-2); line-height: 1.65;">
          Every Writer, Designer, and Video output flows through the Compliance agent before anything reaches you. If the brand-voice score, factual grounding, legal-compliance backstop, embargo check, prior-post deduplication, banned phrase, learned-rule, or platform-publishability check fails — the post is <strong>held with the reason shown</strong>. Eight checks per post. No silent hallucinations. No off-brand visuals slipping through.
        </p>
      </div>
      ...
      <div id="agents" style="grid-column: 7 / span 6; display: grid; grid-template-columns: 1fr 1fr; gap: 18px;">
        @php
          ...
          // hard gate that runs 8 checks (see ComplianceAgent::handle).
          $agents = [
    ...
    <p class="rvl" style="margin-top: 32px; font-family: var(--mono); font-size: 11px; letter-spacing: 0.12em; text-transform: uppercase; color: var(--mute); text-align: center;">
      Plus a Scheduler that ships approved posts to your connected social accounts, an Optimizer that retunes weekly from real engagement, a Repurpose agent that recycles winners across platforms, and a Competitor-intel agent that refreshes Mondays
    </p>
  </div>
</section>
  ...
  <div class="wrap">
    ...
    <div class="grid-12" style="gap: 24px;">
      @php
        ...
        // the first place.
        $lanes = [
          ['name' => 'Green lane', 'color' => 'var(--primary)', 'rule' => 'Auto-publish if Compliance passes.', 'use' => 'Evergreen tips, recurring formats, brand-value content. Runs while you sleep — every post still passes the 8-check Compliance gate first.'],
