          ...
          <tr>
            <td style="padding: 32px 32px 0;">
              ...
              <p style="margin: 16px 0 0; font-size: 15px; line-height: 1.55; color: #2A3438;">
                Your <strong>{{ $planName }}</strong> workspace <strong>{{ $workspace->name }}</strong> is ready. Your card has been charged for your first month. <strong>Next:</strong> we'll send you a secure one-time link to connect your social accounts (Instagram, Facebook, TikTok, LinkedIn, YouTube, Threads) within 1 business day.
              </p>
            </td>
          </tr>
                  ...
                  <td style="padding: 24px;">
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="6" style="font-size: 14px; color: #0F1A1D;">
                      ...
                      <tr>
                        ...
                        <td style="padding: 4px 0;">{{ $planName }} &middot; charged today</td>
                      </tr>
                    </table>
                  </td>
                </tr>
