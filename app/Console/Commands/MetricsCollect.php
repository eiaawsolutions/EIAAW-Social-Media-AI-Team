 ...
 *
 * Source: MetricsProviderRouter picks the collector per post (Meta Graph for
 * owned accounts, Metricool otherwise). When a provider has no reading yet it
 * records "no data yet" (no fabricated values) and begins capturing real
 * numbers automatically once data is available — this tiered cron already
 * drives that path, no further wiring needed.
 */
