...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        // Temp uploads always land on the LOCAL disk first (never R2/S3): the
        // browser streams the desktop file here, then our FileUpload->action
        // moves the validated file to the permanent disk (R2 in prod, public
        // locally). Pinning this makes the temp path deterministic on Railway
        // and avoids a needless round-trip of half-uploaded bytes to R2.
        'disk' => env('LIVEWIRE_TEMPORARY_FILE_UPLOAD_DISK', 'local'),

        // CRITICAL: Livewire's DEFAULT temp-upload cap is max:12288 (12 MB),
        // which silently rejected any desktop photo/short video larger than
        // 12 MB BEFORE Filament's own ->maxSize(50 MB) validation ran — the
        // user saw "upload failed / button unresponsive". Raise it to 51200 KB
        // (50 MB) to match the BrandAssets FileUpload field's advertised limit.
        // 'file' (not 'image') so we also accept video/* the field allows.
        ...
        'preview_mimes' => [                                  // Supported file types for temporary pre-signed file URLs...
            ...
            'heic', 'heif', 'avif',                           // common desktop / iPhone exports
        ],
        // 50 MB videos over a slow uplink can exceed the default 5-minute window.
